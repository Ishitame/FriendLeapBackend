...
const EditProfile = () => {
    ...
    const editProfileHandler = async () => {
        ...
        if (input.profilePhoto) {
            formData.append("profilePhoto", input.profilePhoto); // Ensure it's a file object
        }
        ...
        try {
            ...
            const res = await AxiosInstance.post('profile/edit', formData, {
                headers: {
        ...
        <div className='flex max-w-2xl mx-auto pl-10'>
            <section className='flex flex-col gap-6 w-full my-8'>
                ...
                <div className='flex items-center justify-between bg-gray-100 rounded-xl p-4'>
                    ...
                    <input ref={imageRef} name='profilePhoto' onChange={fileChangeHandler} type='file' className='hidden' />
